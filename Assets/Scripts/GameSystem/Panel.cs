...
public class Panel : MonoBehaviour
{
    ...
    public void DisapperPanel()
    {
        ...
        DOTween.To(() => panelAlphaValue, x => panelAlphaValue = x, 0, .2f)
            .OnUpdate(() =>
            {
                panels[panelIndex].alpha = panelAlphaValue;
            })
    ...
    {
        transitionCircle.DOScale(Vector3.zero, .5f).SetId(this).OnComplete(() => BBSystems.instance.GameManager.CanClick = false);
    }
}
